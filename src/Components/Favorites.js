  ...
  const openNow = (place) => {
    ...
    for (let openingHours of place.opening_hours)
      if (openingHours.open.day === today && openingHours.close.day === today) {
        ...
        openingHours.open.day === today &&
        openingHours.close.day !== today
      ) {
    ...
    <>
      <div>
        <div id="categoryContainer">
          <div id="categoryHeader">Favorites</div>
          {deletedFavorite ? (
            <div id="opensSoon">
              {deletedFavorite.name} just removed from favorites.
            </div>
          ) : (
            ""
          )}
              ...
              return (
                <div key={place.id}>
                  ...
                  >
                    ...
                    <CardContent>
                      {openNow(place) ? (
                        <span id="openNow">Currently Open!</span>
                      ) : (
                        <span id="opensSoon">Currently Closed!</span>
                      )}
                      {openSoon(30, place) ? (
                        <span id="opensSoon">but it opens soon, hang on!</span>
                      ) : (
                        ""
                      )}
                      {closingSoon(120, place) ? (
                        <span id="opensSoon">
                          but it closes soon! go go go!
                        </span>
                      ) : (
                        ""
                      )}
                      ...
                      >
                        ...
                        <Box>
                          <Stack spacing={1}>
                            ...
                            <Button
                              onClick={(ev) =>
                                saveNotesAndRating(place, auth, ev.target.value)
                              }
                            >
                              Save
                            </Button>
